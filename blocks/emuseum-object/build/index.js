...
/* unused harmony default export */ var __WEBPACK_DEFAULT_EXPORT__ = (weakMemoize);
...
/* harmony export */ });
/* unused harmony exports C, _, a, b, d */
...
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(react__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _emotion_cache__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @emotion/cache */ "./node_modules/@emotion/cache/dist/emotion-cache.browser.esm.js");
/* harmony import */ var _emotion_element_cbed451f_browser_esm_js__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./emotion-element-cbed451f.browser.esm.js */ "./node_modules/@emotion/react/dist/emotion-element-cbed451f.browser.esm.js");
...
var jsx = function jsx(type, props) {
  ...
  if (props == null || !_emotion_element_cbed451f_browser_esm_js__WEBPACK_IMPORTED_MODULE_7__.h.call(props, 'css')) {
    // $FlowFixMe
  ...
  createElementArgArray[0] = _emotion_element_cbed451f_browser_esm_js__WEBPACK_IMPORTED_MODULE_7__.E;
  createElementArgArray[1] = (0,_emotion_element_cbed451f_browser_esm_js__WEBPACK_IMPORTED_MODULE_7__.c)(type, props);
...
var Global = /* #__PURE__ */(0,_emotion_element_cbed451f_browser_esm_js__WEBPACK_IMPORTED_MODULE_7__.w)(function (props, cache) {
  ...
  var serialized = (0,_emotion_serialize__WEBPACK_IMPORTED_MODULE_6__.serializeStyles)([styles], undefined, (0,react__WEBPACK_IMPORTED_MODULE_0__.useContext)(_emotion_element_cbed451f_browser_esm_js__WEBPACK_IMPORTED_MODULE_7__.T));
...
var Insertion = function Insertion(_ref) {
  ...
  var rules = (0,_emotion_element_cbed451f_browser_esm_js__WEBPACK_IMPORTED_MODULE_7__.u)(function () {
...
var ClassNames = /* #__PURE__ */(0,_emotion_element_cbed451f_browser_esm_js__WEBPACK_IMPORTED_MODULE_7__.w)(function (props, cache) {
  ...
  var content = {
    css: css,
    cx: cx,
    theme: (0,react__WEBPACK_IMPORTED_MODULE_0__.useContext)(_emotion_element_cbed451f_browser_esm_js__WEBPACK_IMPORTED_MODULE_7__.T)
  };
...
/***/ "./wp-content/plugins/mocp-emuseum-integration/blocks/emuseum-object/src/edit.tsx":
/*!****************************************************************************************!*\
  !*** ./wp-content/plugins/mocp-emuseum-integration/blocks/emuseum-object/src/edit.tsx ***!
  \****************************************************************************************/
...
var components_2 = __webpack_require__(/*! @wordpress/components */ "@wordpress/components");
var block_editor_1 = __webpack_require__(/*! @wordpress/block-editor */ "@wordpress/block-editor");
var components_3 = __webpack_require__(/*! @wordpress/components */ "@wordpress/components");
var components_4 = __webpack_require__(/*! @wordpress/components */ "@wordpress/components");
var server_side_render_1 = __importDefault(__webpack_require__(/*! @wordpress/server-side-render */ "@wordpress/server-side-render"));
...
function Edit(_a) {
    ...
    var _b = (0, element_1.useState)([]), loadedResults = _b[0], setLoadedResults = _b[1];
    var updateObjectID = function (newID) {
        setAttributes({ objectId: Number(newID) });
    };
    var updateObjectTitle = function (newTitle) {
        setAttributes({ objectTitle: newTitle });
    };
    var handleInputChange = function (newValue) {
        var _a;
        var selectedOption = loadedResults.find(function (option) { return Number(option.sourceId.value) === Number(newValue.value); });
        updateObjectID(newValue.value);
        updateObjectTitle((_a = selectedOption === null || selectedOption === void 0 ? void 0 : selectedOption.title) === null || _a === void 0 ? void 0 : _a.value);
    };
    var getSearchResults = function (inputValue) { return __awaiter(_this, void 0, void 0, function () {
        var response, responseBody, results, formattedResults;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4, fetch(inputValue
                        ? "/wp-json/mocp/v1/emuseum-proxy/?path=search/".concat(inputValue, "/objects/json")
                ...
                case 2:
                    ...
                    results = Boolean(inputValue)
                        ? responseBody === null || responseBody === void 0 ? void 0 : responseBody.results
                        : responseBody === null || responseBody === void 0 ? void 0 : responseBody.objects;
                    formattedResults = results.map(function (result) {
                        var _a, _b, _c;
                        return ({
                            label: "".concat((_a = result === null || result === void 0 ? void 0 : result.title) === null || _a === void 0 ? void 0 : _a.value, " (").concat((_b = result === null || result === void 0 ? void 0 : result.sourceId) === null || _b === void 0 ? void 0 : _b.value, ")"),
                            value: parseInt((_c = result === null || result === void 0 ? void 0 : result.sourceId) === null || _c === void 0 ? void 0 : _c.value, 10),
                        });
                    });
                    setLoadedResults(results);
                    return [2, formattedResults];
            }
        });
    }); };
        ...
        React.createElement(block_editor_1.InspectorControls, null,
            React.createElement(components_1.Panel, null,
                React.createElement(components_1.PanelBody, null,
                    React.createElement(components_4.__experimentalText, null, "Search for an object:"),
                    React.createElement(async_1.default, { cacheOptions: true, defaultOptions: true, loadOptions: getSearchResults, onChange: handleInputChange, value: (attributes === null || attributes === void 0 ? void 0 : attributes.objectId) ? {
                            label: "".concat(attributes === null || attributes === void 0 ? void 0 : attributes.objectTitle, " (").concat(attributes.objectId, ")"),
                            value: attributes.objectId,
                        } : null, menuPortalTarget: document.body, menuPosition: 'fixed', styles: {
                    ...
                    React.createElement(components_2.TextControl, { label: "Or if you have an eMuseum ID, set it here:", value: (attributes === null || attributes === void 0 ? void 0 : attributes.objectId) || '', onChange: updateObjectID })))),
        React.createElement("div", __assign({}, blockProps),
            React.createElement(server_side_render_1.default, { block: "mocp/emuseum-object", attributes: attributes, LoadingResponsePlaceholder: components_3.Spinner }))));
}
...
/***/ "./wp-content/plugins/mocp-emuseum-integration/blocks/emuseum-object/src/index.ts":
/*!****************************************************************************************!*\
  !*** ./wp-content/plugins/mocp-emuseum-integration/blocks/emuseum-object/src/index.ts ***!
  \****************************************************************************************/
/***/ (function(__unused_webpack_module, exports, __webpack_require__) {
...
var edit_1 = __importDefault(__webpack_require__(/*! ./edit */ "./wp-content/plugins/mocp-emuseum-integration/blocks/emuseum-object/src/edit.tsx"));
(0, blocks_1.registerBlockType)('mocp/emuseum-object', {
    edit: edit_1.default,
...
/* harmony export */ });
/* unused harmony exports rulesheet, namespace */
...
/******/ 	var __webpack_exports__ = __webpack_require__("./wp-content/plugins/mocp-emuseum-integration/blocks/emuseum-object/src/index.ts");
/******/ 	
/******/ })()
;
